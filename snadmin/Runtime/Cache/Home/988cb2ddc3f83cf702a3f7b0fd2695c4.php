...
<body>
  ...
  <tr>
    <td> <form id="form1" name="form1" method="post" action="/admin8899.php/Home/Index/jiaoyi">
	 
   <input name="user" type="text" class="dfinput" id="user" />
	<input name="" type="submit" class="btn" value="确认搜索"/>
      </form></td>
	  <td>
	    <form id="form1" name="form1" method="post" action="/admin8899.php/Home/Index/jiaoyi">
  ...
  <tr>
    ...
    <td align="right">&nbsp;</td>
     ...
     <table class="tablelist">
		...
		<td><a href="/admin8899.php/Home/Index/qxjy/id/<?php echo ($v["id"]); ?>" class="tablelink">删除</a></td>
