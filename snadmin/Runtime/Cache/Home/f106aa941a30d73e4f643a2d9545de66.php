...
<!-- 		<div class="formbody">
			...
			<form id="form1" name="user" method="post" action="/admin8899.php/Home/Index/kjsy">
				<ul class="forminfo">
					<label>&nbsp;</label>
...
<!-- version: 5.0 -->
					<li>
						...
						<input name="is_op" type="text" id="is_op"
						class="dfinput" required="true" value="<?php echo ($is_op); ?>" />$
	...
	<form id="form8" name="form8" method="post" action="/admin8899.php/Home/Index/settings">
		<input name="UE_account" type="hidden" class="dfinput" value="<?php echo ($userdata['ue_account']); ?>"
		/>
		<ul class="forminfo">
			 <li>
				...
				<input name="wallet_service"  type="text" id="wallet_service"
				class="dfinput" required="true" value="<?php echo $wallet_service;?>" />%
			...
			<li>
				...
				<input name="wallet_open"  type="text" id="wallet_open"
				class="dfinput" required="true" value="<?php echo $wallet_open;?>" />
