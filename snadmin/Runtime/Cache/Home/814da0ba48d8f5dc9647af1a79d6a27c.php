    ...
    <table class="tablelist">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 <td><?php echo ($v["if_id"]); ?></td>
	      ...
	      <td><a href="/admin8899.php/Home/Shop/zsbyg_list_xg4/id/<?php echo ($v["if_id"]); ?>/" class="tablelink">修改</a>　<a href="/admin8899.php/Home/Shop/zsbyg_list_del/id/<?php echo ($v["if_id"]); ?>/" class="tablelink">删除</a></td>
