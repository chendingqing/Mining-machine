...
<div style="width:100%;">
	...
	<div style="padding:10px 0;margin:20px 0;background:transparent;width:100%">
        ...
        <span id="money" style="text-align: left;color: #02d2f5;font-size: 25px;padding-left: 15px"><?php echo ($price); ?> <small style="font-size: 14px;color: rgba(255,255,255,.7)">HBC</small></span>
	</div>
