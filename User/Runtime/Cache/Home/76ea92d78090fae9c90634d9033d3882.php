...
<div id="qiugou" style="-left: 5%;margin-bottom:80px;margin-top:30px;color: #FFFFFF">
	...
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px;background-color:transparent;">
            ...
            <li style=" color: rgb(0, 0, 0);width: 20%;"><a href="/index.php/Home/Info/delqiugou/?id=<?php echo ($v["id"]); ?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #02d2f5;border-radius: 5px;color: #FFFFFF">取消</a></li>
