...
class AjaxController extends Basis1Controller{
	public function getmobilecode1(){
		...
		$text="【GEC中国】您正在找回密码，您的新密码是".$qycode;
	...
	public function testmobile(){
		...
		$content="您的验证码是{$code}【AFC】";
		
		
      $url="http://utf8.sms.webchinese.cn/?Uid=chinafc&Key=ce04e2fedab6d08f1c66&smsMob=$mobile&smsText=$content";
